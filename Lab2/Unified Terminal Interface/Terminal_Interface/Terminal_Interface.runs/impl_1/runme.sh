...
HD_PWD='C:/Users/wkrska/Downloads/temp/EC551_Labs/Lab2/Unified Terminal Interface/Terminal_Interface/Terminal_Interface.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log term_interf_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source term_interf_top.tcl -notrace

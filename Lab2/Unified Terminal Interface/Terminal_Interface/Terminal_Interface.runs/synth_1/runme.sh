...
HD_PWD='X:/EC551/Labs/Lab1/Final Copy/EC551_Labs/Lab2/Unified Terminal Interface/Terminal_Interface/Terminal_Interface.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log term_interf_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source term_interf_top.tcl

...
HD_PWD='C:/Users/wkrska/Downloads/temp labs/EC551_Labs/lab3/lab_3/lab_3.runs/ascii_char_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ascii_char_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ascii_char_fifo.tcl

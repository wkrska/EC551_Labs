...
set_property IOSTANDARD LVCMOS33 [get_ports {switch_RS[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {switch_RS[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {switch_RS[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {switch_RS[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {switch_RS[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {switch_RS[0]}]
